...
/*This class defines the usual status (HttpStatus code provided by spring boot)
code and a custom status code in case
* my company requires a custom status code*/
